...
<body class="transition-colors">
  ...
  <section class="bg-primary flex w-full fixed bottom-0 h-6 justify-end pr-5 items-center gap-5">
    ...
    <a href="paginaLoginTipo.html" class="flex text-sm justify-center items-center bg-white rounded-full h-5 px-2"><img src="img/icons/icon-perfil.svg" alt="icon perfil"> Área do cliente</a>
  </section>
